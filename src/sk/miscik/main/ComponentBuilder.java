...
public class ComponentBuilder {
    ...
    public static ArrayList<Component> getNewComponents(User user) throws Exception {
        ...
        submitButton.addActionListener(e -> {
            try {
                ...
                if (firstNameField.getText().trim().equals("") || lastNameField.getText().trim().equals("") || emailField.getText().trim().equals("")
                        || phoneField.getText().trim().equals("") || positionBox.getSelectedItem() == null || cityBox.getSelectedItem() == null ||
                        roomBox.getSelectedItem() == null || date == null) {
                    JOptionPane.showMessageDialog(null, "Please fill in the fields!", "Error", JOptionPane.ERROR_MESSAGE);
                //CHECK IF DATE IS AFTER TODAY
                } else if (date.getTime() < new Date().getTime()) {
                    JOptionPane.showMessageDialog(null, "The selected date is before the current date!", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    ...
                    if (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY) {
                        JOptionPane.showMessageDialog(null, "The selected date is Saturday/Sunday!", "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
    ...
    public static ArrayList<Component> getViewComponents(User user) {
        ...
        row1info.addActionListener(e->new ApplicantInfo(user, applicants[0], (ManagementGUI) frame));
        Cs.add(row1info);
        ...
        row2info.addActionListener(e->new ApplicantInfo(user, applicants[1], (ManagementGUI) frame));
        Cs.add(row2info);
        ...
        row3info.addActionListener(e->new ApplicantInfo(user, applicants[2], (ManagementGUI) frame));
        Cs.add(row3info);
        ...
        row4info.addActionListener(e->new ApplicantInfo(user, applicants[3], (ManagementGUI) frame));
        Cs.add(row4info);
        ...
        row5info.addActionListener(e->new ApplicantInfo(user, applicants[4], (ManagementGUI) frame));
        Cs.add(row5info);
        ...
        refresh.setSize(650,25);
        refresh.setLocation(140, 440);
        refresh.addActionListener(e -> ((ManagementGUI)ComponentBuilder.frame).refreshViewCs());
        Cs.add(refresh);
